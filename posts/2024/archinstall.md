---
title: "安装 Arch Linux"
description: "本文是 Arch Linux 安装教程，安装前需确认 UEFI 启动，准备镜像、写盘工具等。先将镜像写入 USB，启动时关闭安全启动。安装过程涵盖联网、换源、分区、创建 Btrfs 分区，再安装基本系统、配置新系统、安装引导。最后配置网络、添加用户、设置源，以 KDE Plasma 为例安装桌面 。
"
clock: "2024-08-06"
---
