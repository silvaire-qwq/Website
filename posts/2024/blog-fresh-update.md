---
title: "全新的博客界面"
description: "作者分享 2024 年 11 月未发文期间博客的更新内容。在 CSS 方面对顶栏、文章内部等做改动，采用卡片式样式。通过 VitePress 官方示例学习 Vue 并应用于主页、友情链接等界面。友情链接用 Vue 代码简化添加操作，借鉴他人源码改进文章列表，用 Vue 优化文章顶部，还将易改配置放于 /config.json 。"
clock: "2024-12-13"
---
